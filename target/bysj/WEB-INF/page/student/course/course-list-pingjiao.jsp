    ...
    layui.use(['layer', 'datatable', 'datatableButton', 'datatableFlash', 'datatableHtml5', 'datatablePrint', 'datatableColVis', 'datatableSelect'], function () {
        ...
        $(document).ready(function () {
            var myTable = $('#courseTable').DataTable({
                ...
                "ajax": {
                    url: 'pingjiaoList.shtm?keyword=' + $("#keyword").val(),
                    dataSrc: 'courses'
                },
                ...
                "columns": [
                    ...
                    },
                    {
                        "data": function(obj){
                            if(obj.status=="0"){
                                return '<span class="label label-success radius">已评教</span>';
                            } else {
                                return '<span class="label label-default radius">未评教</span>';
                            }
                        },
                        "sTitle": "状态", //标题
                        "sType": 'chinese',
            ...
            function reloadTable() {
                ...
                myTable.ajax.url('pingjiaoList.shtm?keyword=' + $("#keyword").val()).load();
            }
        ...
        /*课程-评教*/
        $('.table-sort').on('click', '.handle-pingjiao', function () {
            var obj = $(this);
            var courseid = $(obj).parents("tr").find("td:nth-child(2)").html();
            var coursename = $(obj).parents("tr").find("td:nth-child(3)").html();
            var teachername = $(obj).parents("tr").find("td:nth-child(4)").html();
            console.log(courseid);
            var href = 'pingjiaoView.shtm?courseid='+courseid;
            layer_show(""+teachername+":"+coursename, href, '', '800', '500');
        });
