        ...
        <ul class="layui-nav layui-nav-tree" id="sideNav" lay-filter="sideNav">
            ...
            <li class="layui-nav-item layui-nav-itemed"><a>课程管理</a>
                <dl class="layui-nav-child">
                    <dd><a href="javascript:;" data-url="<%=basePath%>student/course/selectCourseView.shtm"><label>学生选课</label></a>
                    </dd>
                    <dd><a href="javascript:;" data-url="<%=basePath%>student/course/myCourseView.shtm"><label>我的课程</label></a></dd>
                </dl>
            </li>


            <li class="layui-nav-item"><a>学生评教</a>
                <dl class="layui-nav-child">
                    <dd><a href="javascript:;" data-url="<%=basePath%>student/course/pingjiaoListView.shtm"><label>课程列表</label></a></dd>
                </dl>
