...
<div class="layui-layout-admin fly-body">
    ...
    <div class="layui-side">
        <ul class="layui-nav layui-nav-tree" id="sideNav" lay-filter="sideNav">
            ...
            <li class="layui-nav-item"><a>课程管理</a>
                <dl class="layui-nav-child">
            ...
            <li class="layui-nav-item"><a>评教管理</a>
                <dl class="layui-nav-child">
                    <dd><a href="javascript:;" data-url="<%=basePath%>admin/pingjiao/pingjiaoList.shtm"><label>评教内容设置</label></a></dd>
                </dl>
                <dl class="layui-nav-child">
            ...
            <li class="layui-nav-item"><a>信息查询</a>
                <dl class="layui-nav-child">
                    <dd><a href="javascript:;" data-url="article/article-list.html"><label>选课信息查询</label></a></dd>
                    <dd><a href="javascript:;" data-url="article/article-sorts.html"><label></label></a></dd>
                </dl>
            </li>
