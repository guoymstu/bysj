...
<script>
    ...
    layui.use(['layer', 'datatable', 'datatableButton', 'datatableFlash', 'datatableHtml5', 'datatablePrint', 'datatableColVis', 'datatableSelect'], function () {
            ...
            var myTable = $('#courseTable').DataTable({
                ...
                "columns": [
                    ...
                    },
                    {
                        "data": function(obj){
                            if(obj.status=="1"){
                                ...
                                return '<span class="label label-default radius">未分配</span>';
                            }
                        },
                        "className": "td-status",
                        "sTitle": "状态", //标题
...

                    {
                        "data": function (obj) {
                            if (obj.status == "0") {
                                return '<button class="layui-btn handle-btn-select">选择</button>' ;
                            } else {
        ...
        /*教师-选课*/
        $('.table-sort').on('click', '.handle-btn-select', function () {
            var obj = $(this);
            var courseid = $(obj).parents("tr").find("td:nth-child(2)").html();
            console.log(courseid);
            layer.confirm('确认要选择吗？', {
                icon: 0,
                title: '警告',
                shade: false
            }, function (index) {
                ...
                $.ajax({
                    async: false,
                    url: '/teacher/course/selcourse.shtm',
