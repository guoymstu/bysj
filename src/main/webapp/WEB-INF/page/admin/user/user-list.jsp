...
<div class="tab-body"><p class="page-tab"><span class="layui-breadcrumb" lay-separator=">"><a href="">首页</a><a><cite>用户列表</cite></a></span>
    ...
    <div class="handle-box">
        <ul>
            <li class="handle-item"><span class="layui-form-label">输入学号或姓名：</span>
                <div class="layui-input-inline"><input id="keyword" name="keyword" type="text" autocomplete="off"
                                                       placeholder="请输入搜索条件"
                                                       class="layui-input"></div>

                <div class="layui-input-inline">
                    <select id="role" class="layui-input layui-input-inline" name="role" lay-verify="">
    ...
    layui.use(['layer', 'datatable', 'datatableButton', 'datatableFlash', 'datatableHtml5', 'datatablePrint', 'datatableColVis', 'datatableSelect'], function () {
        ...
        $(document).ready(function () {
            var myTable = $('#userTable').DataTable({
                ...
                "aoColumnDefs": [{
                    "orderable": false,
                    "aTargets": [0, 9] // 指定列不参与排序
                }],
                "deferRender": true, //延迟渲染
                "ajax": {
                    url: 'getUser.shtm?keyword=' + $("#keyword").val() + '&role=' + $("#role").val(),
                    dataSrc: 'users'
                },
                ...
                "columns": [
                    { //定义列
                        "data": function (obj) {
                            return '<input type="checkbox" class="fly-checkbox" name="sublist" data-id=' + obj.uid + '>';
                        },
            ...
            function reloadTable() {
                ...
                myTable.ajax.url('getUser.shtm?keyword=' + $("#keyword").val() + '&role=' + $("#role").val()).load();
            }
        ...
        $("#btn-addstu").on('click', function () {
            ...
            var href = 'user-add.shtm?role=student';
