...
<body>
    <div class="handle-box">
        <ul>
            <li class="handle-item"><span class="layui-form-label">输入关键词：</span>
                ...
                <div class="fr">
                    <a class="layui-btn btn-add btn-default" id="btn-addclass"><i class="linyer icon-add"></i> 添加班级</a>
                </div>
