        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="courseid" lay-filter="courseid" lay-verify="courseid" autocomplete="off"
                       placeholder="请输入课程编号" class="layui-input" value="${course.id}">
            </div>
        </div>
        <%--课程名--%>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="coursename" lay-filter="coursename" lay-verify="coursename" autocomplete="off"
                       placeholder="请输入课程名" class="layui-input" ${course.coursename}>
            </div>
        </div>
        <%--课时--%>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="coursehours" lay-filter="coursehours" lay-verify="coursehours"
                       autocomplete="off"
                       placeholder="请输入课时" class="layui-input" value="${coursehours}">
            </div>
        </div>
        <%--上课地址--%>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="address" lay-filter="address" lay-verify="address"
                       autocomplete="off"
                       placeholder="请输入上课地址" class="layui-input" value="${course.address}">
            </div>
        </div>
        <%--学分--%>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="coursescore" lay-filter="coursescore" lay-verify="coursescore"
                       autocomplete="off"
                       placeholder="请输入学分" class="layui-input" value="${course.coursescore}">
            </div>
        </div>
        <%--开设时间--%>
        <div class="layui-form-item" lay-verify="">
            ...
            <div class="layui-input-inline">
                <input name="year" id="year" lay-filter="" placeholder="选择年份" class="layui-input"
                       onClick="WdatePicker({dateFmt:'yyyy',maxDate:new Date().getFullYear()+1})" value="${course.year}"/>
            </div>

            <div class="layui-input-inline">
                <select name="term" id="term" lay-filter="term">
                    <option value="上学期" <c:if test="${course.term eq '上学期'}">selected="selected"</c:if>上学期</option>
                    <option value="下学期" <c:if test="${course.term eq '下学期'}">selected="selected"</c:if>下学期</option>
                </select>
            </div>
        </div>
        <%--课程类型--%>
                ...
                <select name="coursetype">
                    <c:if test="${not empty coursetypes}">
                        ...
                        <c:forEach var="item" items="${coursetypes}">
                            <option value="${item.coursetype}"   <c:if test="${course.coursetype==item.coursetype}">selected="selected"</c:if>>${item.coursetype}</option>
                        </c:forEach>
                    </c:if>
                </select>
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="timeplan" lay-filter="timeplan" lay-verify="timeplan"
                       autocomplete="off"
                       placeholder="具体时间安排" class="layui-input" value="${course.timeplan}">
            </div>
        </div>
        <%--上课人数--%>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="tel" name="countstu" lay-verify="countstu" autocomplete="off" placeholder="请输入上课人数"
                       maxlength="11" class="layui-input" value="${course.countstu}">
            </div>
        </div>
