    ...
    layui.use(['layer', 'datatable', 'datatableButton', 'datatableFlash', 'datatableHtml5', 'datatablePrint', 'datatableColVis', 'datatableSelect'], function () {
        ...
        $(document).ready(function () {
            var myTable = $('#courseTable').DataTable({
                ...
                "ajax": {
                    url: 'myCourse.shtm?keyword=' + $("#keyword").val(),
                    dataSrc: 'courses'
                },
                ...
                "columns": [
                    ...
                    {
                        "data": function (obj) {
                            return '<button class="layui-btn handle-recall">退选</button>' ;
                        },
                        "className": "td-handle",
                        "sTitle": "操作", //标题
                        "sDefaultContent": "", //此列默认值为""，以防数据中没有此值，DataTables加载数据的时候报错
            ...
            function reloadTable() {
                ...
                myTable.ajax.url('myCourse.shtm?keyword=' + $("#keyword").val()).load();
            }
        ...
        /*学生退课*/
        $('.table-sort').on('click', '.handle-recall', function () {
            var obj = $(this);
            var courseid = $(obj).parents("tr").find("td:nth-child(2)").html();
            console.log(courseid);
            layer.confirm('确认要退选吗？', {
                icon: 0,
                title: '警告',
                shade: false
            }, function (index) {
                ...
                $.ajax({
                    async: false,
                    url: '/student/course/recallcourse.shtm',
