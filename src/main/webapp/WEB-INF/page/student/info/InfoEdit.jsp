    ...
    <form class="layui-form" action="" method="post">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="uid" value="${student.id}" lay-filter="uid" lay-verify="uid" autocomplete="off"
                           placeholder="请输入学号/工号" class="layui-input" readonly="readonly">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="username" value="${student.name}" lay-filter="username" lay-verify="username" autocomplete="off"
                           placeholder="请输入用户名" class="layui-input" readonly="readonly">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="tel" name="telnum" value="${student.telnum}" lay-verify="mobile" autocomplete="off" placeholder="请输入手机号"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="email" value="${student.mail}" lay-verify="emails" autocomplete="off" placeholder="请输入邮箱"
                           class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="idcardnum" value="${student.idcardnum}" lay-verify="idcard" autocomplete="off" placeholder="请输入身份证号码"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline sw-times2">
                    <input type="text" name="address" lay-verify="address" value="${student.address}" autocomplete="off" placeholder="请输入街道、楼牌号等"
                           class="layui-input">
                </div>
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <button class="layui-btn" lay-submit="" id="add" lay-filter="saveuser">立即提交</button>
